...
const CONFIG_PARAM = {
    development: {
        ...
        AWS_S3_BUCKET_NAME: "cse23-donorconnect-dev",
    },
    production: {
        PORT: "4000",
        JWT_ACCESS_SECRET: process.env.JWT_ACCESS_SECRET,
        ...
        AWS_SECRET_ACCESS_KEY: process.env.AWS_SECRET_ACCESS_KEY,
        AWS_REGION: process.env.AWS_REGION,
        AWS_S3_BUCKET_NAME: "cse23-donorconnect",
    },
};
...
const AWS_ACCESS_KEY_ID = CONFIG_PARAM[ENVIRONMENT].AWS_ACCESS_KEY_ID;
const AWS_SECRET_ACCESS_KEY = CONFIG_PARAM[ENVIRONMENT].AWS_SECRET_ACCESS_KEY;
const AWS_REGION = CONFIG_PARAM[ENVIRONMENT].AWS_REGION;
const AWS_S3_BUCKET_NAME = CONFIG_PARAM[ENVIRONMENT].AWS_S3_BUCKET_NAME;

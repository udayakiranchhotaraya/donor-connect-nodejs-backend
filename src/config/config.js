...
const CONFIG_PARAM = {
    development: {
        ...
        FRONTEND_BASE_URL: process.env.FRONTEND_BASE_URL ?? `http://localhost:4001`,
        TABLE_NAMES: {
...
const JWT_VERIFICATION_SECRET = CONFIG_PARAM[ENVIRONMENT].JWT_VERIFICATION_SECRET;
...
const FACEBOOK_OAUTH_CONFIG = CONFIG_PARAM[`${ENVIRONMENT}`].FACEBOOK_OAUTH_CONFIG;
...
const ERROR_MESSAGES = {
    ...
    OPERABLE_CENTER_LIMIT_EXCEEDED: 'You have reached the maximum limit of centers',
